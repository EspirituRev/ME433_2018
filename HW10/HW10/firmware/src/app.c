...
//      
            ...
            //MAF
            MoveBuffer(BMAF,accelz);
            VMAF=MAF(BMAF);
            
            //FIR
            MoveBuffer(BFIR,accelz);
            VFIR=FIR(BFIR);
            
            //IR
            VIR=Alpha*VIR+Betha*faccelz;
            
            sprintf(message2,"TEMP: %d  ",temp);
            LCD_drawString(15,25,message2,WHITE,screen);

            sprintf(message2,"X: %3.0f  ",BMAF[0]);
            LCD_drawString(15,35,message2,WHITE,screen);

            sprintf(message2,"Y: %3.0f  ",BMAF[1]);
            LCD_drawString(15,45,message2,WHITE,screen);

            sprintf(message2,"Z: %3.0f  ",BMAF[2]);
            LCD_drawString(15,55,message2,WHITE,screen);
            
            sprintf(message2,"AV: %3.0f  ",VMAF);
            LCD_drawString(15,65,message2,WHITE,screen);
            
            sprintf(message2,"AV: %3.0f  ",VIR);
            LCD_drawString(15,75,message2,WHITE,screen);
            
            sprintf(message2,"AV: %3.0f  ",VFIR);
            LCD_drawString(15,85,message2,WHITE,screen);
            ...
            len = sprintf(dataOut,"%d %3.0f %3.0f %3.0f %3.0f\r\n", 
                    i+1, faccelz, VMAF, VIR, VFIR);
