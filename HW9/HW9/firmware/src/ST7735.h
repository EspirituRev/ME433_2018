...
void LCD_drawChar(unsigned char, unsigned char, unsigned char, unsigned short, unsigned short);//draw a char
void LCD_drawString(unsigned char, unsigned char, unsigned char*, unsigned short, unsigned short);//draw a string
void LCD_drawBarHor(unsigned char, unsigned char, unsigned char, unsigned char,  unsigned int, unsigned short,unsigned short);//draw the border of the bar
void LCD_drawBarVer(unsigned char, unsigned char, unsigned char, unsigned char,  unsigned int, unsigned short,unsigned short);//draw the border of the bar
